...
void firstComeFirstServe()
{
    ...
    for (int i = 0; i < process_count; i++)
    {
        ...
        //This loop marks the execution time of the current process in the timeline array
        for (int j = time; j < finishTime[processIndex]; j++)
            timeline[j][processIndex] = '*';

        //This loop marks the waiting time of the current process before it starts execution
